...
public class Player_Movement : MonoBehaviour
{
    ...
    void Movement()
    {
        ...
        //Se me olvido como hacer el smooth asi que te lo dejo sin Raw el get axis, aunque se pierde un poco la precisión de movimiento :D
    ...
    //No funciona, pero no da error ._.
    ...
    private void OnCollisionEnter(Collision other) 
    {
        if(other.gameObject.tag == "Boxes")
        {
            ...
            rb.AddForce(forceBox * Vector3.up);
        }    
    }
